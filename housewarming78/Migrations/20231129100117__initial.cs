        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CountRooms = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    ViewFromTheWindows = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    ConstructionSeries = table.Column<int>(type: "int", nullable: true),
                    NumberOfElevators = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FloorType = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Entrances = table.Column<int>(type: "int", nullable: true),
                    Heating = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AccidentRate = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    GasSupply = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    EnFloorsInTheHouse = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "44546e06-8719-4ad8-b88a-f271ae9d6eab", "e813c006-ef5c-42a0-950c-f6525dae31d1", "admin", "ADMIN" });

            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "Email", "EmailConfirmed", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { "3b62472e-4f66-49fa-a20f-e7685b9565d8", 0, "665aead8-0d3c-4820-957a-7391c7b2a32d", "my@email.com", true, false, null, "MY@EMAIL.COM", "ADMIN", "AQAAAAEAACcQAAAAEAcV8zd5t/NF2/EnCeN0QupLN4c6dL4dHT5HHhi08O064GTKl59bT/R58oPIff00eg==", null, false, "", false, "admin" });
